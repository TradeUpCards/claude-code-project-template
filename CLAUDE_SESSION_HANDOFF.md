...
- If Option B/C: read `.project/in-flight.md` for workstream coordination
...
If you're a named lead (Aria/Bram/Cleo in Option C), write to your lead-specific handoff at `.project/handoffs/<name>-handoff.md` instead of this global file. Tate owns this global file.
